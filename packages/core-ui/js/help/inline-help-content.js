...
const docsUrl = (path) => buildDocsUrl(path);
...
const sharedInlineHelpEntries = {
  'import-export-controls': `
      ...
      <ul>
        ...
        <li>"Set Grid From Text"<br> to <a class="helplink" href="${docsUrl('editing-data/text-editing')}" target="anywaydatadocs">import the text box content</a> into the grid.</li>
        <li>"Choose File"<br> to <a class="helplink" href="${docsUrl('editing-data/import-from-file')}" target="anywaydatadocs">import a text file</a> of the chosen format.</li>
        <li>"Download File"<br> to <a class="helplink" href="${docsUrl('editing-data/exporting-data')}" target="anywaydatadocs">export the Data Grid</a> items in the chosen format.</li>
        <li>"Drag and Drop File"<br> to <a class="helplink" href="${docsUrl('editing-data/import-from-file')}" target="anywaydatadocs">import the file</a> contents using the currently chosen format.</li>
      </ul>
  ...
  'import-export-grid-preview-sync': `
      ...
      <ul>
        ...
        <li>"Set Grid From Text"<br> <a class="helplink" href="${docsUrl('editing-data/text-editing')}" target="anywaydatadocs">imports the text box content</a> back into the grid.</li>
      </ul>
  ...
  'import-export-import': `
      ...
      <ul>
        <li>"Choose File"<br> lets you <a class="helplink" href="${docsUrl('editing-data/import-from-file')}" target="anywaydatadocs">import a text file</a> of the chosen format.</li>
  ...
  'import-export-download': `
      <p>Use Download to <a class="helplink" href="${docsUrl('editing-data/exporting-data')}" target="anywaydatadocs">export the Data Grid</a> items in the chosen format.</p>
  ...
  'export-format-tabs-help': `
      ...
      <p><a class="helplink" href="${docsUrl('category/data-formats')}" target="_blank" rel="noopener noreferrer">Data Formats docs</a></p>
    `,
  'markdown-table-options': `
      <p>Export the table data as <a class="helplink" href="${docsUrl('data-formats/markdown/markdown')}" target="anywaydatadocs">Markdown</a>, a human readable format which can be easily converted to HTML or PDF.</p>
      <p>Choose from the list of <a class="helplink" href="${docsUrl('data-formats/markdown/options')}" target="anywaydatadocs">formatting options</a> and press the [Apply] button to render the data in the chosen style.</p>
      <p><a class="helplink" href="${docsUrl('data-formats/markdown/options')}" target="anywaydatadocs">Learn more</a></p>
    `,
  'ascii-table-options': `
      ...
      <p><a class="helplink" href="${docsUrl('data-formats/ascii-tables/options')}" target="anywaydatadocs">Learn more</a></p>
    `,
  'csv-options': `
      <p>Export the table data as <a class="helplink" href="${docsUrl('data-formats/csv/csv')}" target="anywaydatadocs">CSV (Comma Separated Values)</a> suitable for importing into a spreadsheet.</p>
      <p>Choose from the formatting options and press the [Apply] button to render the data in the chosen style.</p>
      <p><a class="helplink" href="${docsUrl('data-formats/csv/options')}" target="anywaydatadocs">Learn more</a></p>
    `,
  'delimiter-options': `
      <p>Export the table data as a <a class="helplink" href="${docsUrl('data-formats/delimited/delimited')}" target="anywaydatadocs">Delimited</a> output suitable for importing or copy and pasting into a spreadsheet.</p>
      <p>Choose from the formatting options and press the [Apply] button to render the data in the chosen style.</p>
      <p><em>Hint: Use Tab delimiter if copying into another table editing application like a spreadsheet.</em></p>
      <p><a class="helplink" href="${docsUrl('data-formats/delimited/options')}" target="anywaydatadocs">Learn more</a></p>
    `,
  'json-options': `
      <p>Export the table data as a <a class="helplink" href="${docsUrl('data-formats/json/json')}" target="anywaydatadocs">JSON</a> output suitable for JSON interchange messages e.g. APIs.</p>
      <p>Choose from the formatting options and press the [Apply] button to render the JSON in the chosen style.</p>
      <p><a class="helplink" href="${docsUrl('data-formats/json/options')}" target="anywaydatadocs">Learn more</a></p>
    `,
  'jsonl-options': `
      ...
      <p><a class="helplink" href="${docsUrl('data-formats/jsonl/jsonl')}" target="anywaydatadocs">Learn more</a> and see <a class="helplink" href="${docsUrl('data-formats/jsonl/options')}" target="anywaydatadocs">JSONL options</a>.</p>
    `,
  'javascript-options': `
      <p>Export the table data as a <a class="helplink" href="${docsUrl('data-formats/javascript/javascript')}" target="anywaydatadocs">Javascript</a> output suitable for using in a Javascript application or unit testing code.</p>
      <p>Choose from the formatting options and press the [Apply] button to render the Javascript in the chosen style.</p>
      <p><a class="helplink" href="${docsUrl('data-formats/javascript/options')}" target="anywaydatadocs">Learn more</a></p>
    `,
  'java-options': `
      ...
      <p><a class="helplink" href="${docsUrl('data-formats/java/options')}" target="anywaydatadocs">Learn more</a></p>
    `,
  'python-options': `
      ...
      <p><a class="helplink" href="${docsUrl('data-formats/python/options')}" target="anywaydatadocs">Learn more</a></p>
    `,
  'php-options': `
      ...
      <p><a class="helplink" href="${docsUrl('data-formats/php/options')}" target="anywaydatadocs">Learn more</a></p>
    `,
  'ruby-options': `
      ...
      <p><a class="helplink" href="${docsUrl('data-formats/ruby/options')}" target="anywaydatadocs">Learn more</a></p>
    `,
  'perl-options': `
      ...
      <p><a class="helplink" href="${docsUrl('data-formats/perl/options')}" target="anywaydatadocs">Learn more</a></p>
    `,
  'kotlin-options': `
      ...
      <p><a class="helplink" href="${docsUrl('data-formats/kotlin/options')}" target="anywaydatadocs">Learn more</a></p>
    `,
  'csharp-options': `
      ...
      <p><a class="helplink" href="${docsUrl('data-formats/csharp/options')}" target="anywaydatadocs">Learn more</a></p>
    `,
  'typescript-options': `
      ...
      <p><a class="helplink" href="${docsUrl('data-formats/typescript/options')}" target="anywaydatadocs">Learn more</a></p>
    `,
  'xml-options': `
      <p>Export the table data as <a class="helplink" href="${docsUrl('data-formats/xml/xml')}" target="anywaydatadocs">XML</a>, suitable for system integration and data interchange.</p>
      ...
      <p><a class="helplink" href="${docsUrl('data-formats/xml/options')}" target="anywaydatadocs">Learn more</a></p>
    `,
  'sql-options': `
      ...
      <p><a class="helplink" href="${docsUrl('data-formats/sql/sql')}" target="anywaydatadocs">Learn more</a> and see <a class="helplink" href="${docsUrl('data-formats/sql/options')}" target="anywaydatadocs">SQL options</a>.</p>
    `,
  'gherkin-options': `
      <p>Export the table data as <a class="helplink" href="${docsUrl('data-formats/gherkin/gherkin')}" target="anywaydatadocs">Gherkin</a>, a human readable format used in BDD automation.</p>
      <p>The <a class="helplink" href="${docsUrl('data-formats/gherkin/options')}" target="anywaydatadocs">formatting options</a> help pretty print the output to fit in the specification.</p>
      <p><a class="helplink" href="${docsUrl('data-formats/gherkin/options')}" target="anywaydatadocs">Learn more</a></p>
    `,
  'html-table-options': `
      <p>Export the table data as a <a class="helplink" href="${docsUrl('data-formats/html/html-tables')}" target="anywaydatadocs">HTML Table</a> suitable for adding to a web page.</p>
      ...
      <p><a class="helplink" href="${docsUrl('data-formats/html/options')}" target="anywaydatadocs">Learn more</a></p>
    `,
  'test-framework-options': `
      ...
      <p><a class="helplink" href="${docsUrl('data-formats/unit-test-code/options')}" target="anywaydatadocs">See full unit-test option mapping</a></p>
    `,
  'shared-generator-screen-overview': `
      ...
      <p><a class="helplink" href="${docsUrl('test-data/generate-to-file')}" target="_blank" rel="noopener noreferrer">Generate To File docs</a></p>
    `,
  ...
  'shared-generator-pairwise-help': `
      ...
      <p><a class="helplink" href="${docsUrl('test-data/pairwise-testing')}" target="_blank" rel="noopener noreferrer">Pairwise testing docs</a></p>
    `,
...
const appOnlyInlineHelpEntries = {
  ...
  'test-data-summary-title': `
      ...
      <p><a class="helplink" href="${docsUrl('test-data/test-data-generation')}" target="anywaydatadocs">Learn more</a></p>
    `,
};
