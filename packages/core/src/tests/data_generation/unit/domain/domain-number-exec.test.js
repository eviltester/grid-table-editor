...
describe('number domain keyword execution', () => {
  ...
  test('executes number.romanNumeral', () => {
    ...
    assertDomainKeywordResult('number.romanNumeral', result);
  });
});
