...
defineDomainKeywordHelpContractTests('string.octal');

describe('string.octal parameter validation', () => {
  function validateArgs(paramsText) {
    const keyword = getDomainKeywordByAlias('string.octal');
    const parsed = parseKeywordInvocation(`string.octal(${paramsText})`);
  ...
  test('executes string.octal(length=5) successfully', () => {
    const parsed = parseKeywordInvocation('string.octal(length=5)');
