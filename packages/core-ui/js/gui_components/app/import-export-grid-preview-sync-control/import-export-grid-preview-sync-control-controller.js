class ImportExportGridPreviewSyncControlController {
  constructor({ props = {} } = {}) {
    this.state = {
      helpDataHelp: props.helpDataHelp || 'import-export-grid-preview-sync',
  ...
  updateProps(nextProps = {}) {
    if (Object.prototype.hasOwnProperty.call(nextProps, 'helpDataHelp')) {
      this.state.helpDataHelp = nextProps.helpDataHelp || 'import-export-grid-preview-sync';
    }
  ...
  canSetTextFromGrid() {
    return this.state.importBusy !== true && this.state.supportsExport === true;
  }
...
export { ImportExportGridPreviewSyncControlController };
