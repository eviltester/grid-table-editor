...
defineDomainKeywordHelpContractTests('word.adjective');

describe('word.adjective parameter validation', () => {
  function validateArgs(paramsText) {
    const keyword = getDomainKeywordByAlias('word.adjective');
    const parsed = parseKeywordInvocation(`word.adjective(${paramsText})`);
  ...
  test('executes word.adjective(length=5) successfully', () => {
    const parsed = parseKeywordInvocation('word.adjective(length=5)');
