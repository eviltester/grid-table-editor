...
const FORMAT_OPTION_NOTES = {
  ...
  junit4: {
    ...
    assertionStyle: 'Assertion style hint used by supported renderers.',
    includeSetup: 'Include framework setup boilerplate where applicable.',
  ...
  junit6: {
    ...
    includeSetup: 'Include framework setup boilerplate where applicable.',
    prettyPrint: 'Format generated output for readability.',
    dataSourceStrategy: 'Data-driven strategy, inline data or provider style.',
  },
  testng: {
    suiteName: 'Name of generated test suite/class.',
    testNamePrefix: 'Prefix used for generated test method names.',
