// based on https://github.com/xpl/printable-characters/blob/master/printable-characters.js
...
const isBlank = printableChars.isBlank;
const partitionf = printableChars.partition;
const strlen = printableChars.strlen;

export {isBlank, partitionf as partition, strlen}