...
The generator runtime entry itself is now mostly a composition layer around smaller helpers such as `create-generator-runtime-base-state.js`, `create-generator-runtime-factory-inputs.js`, `create-generator-runtime-schema-adapters.js`, `create-generator-runtime-instance.js`, `create-generator-runtime-shell-config.js`, `create-generator-runtime-factories.js`, `create-generator-runtime-shell.js`, `create-generator-runtime-core.js`, `create-generator-runtime-lifecycle-facade.js`, `create-generator-runtime-facade.js`, `create-generator-runtime-schema-state.js`, `assert-generator-runtime-mountable.js`, `create-generator-runtime-lifecycle.js`, `create-generator-runtime-dependencies-factory.js`, `create-generator-unavailable-row-count-result.js`, `create-generator-runtime-dependencies.js`, `create-generator-runtime-schema-dependencies.js`, `create-generator-runtime-schema-support-dependencies.js`, `create-generator-runtime-schema-session-dependencies.js`, `create-generator-runtime-schema-bridges.js`, `create-generator-runtime-interaction-dependencies.js`, `create-generator-runtime-view-state-dependencies.js`, `create-generator-runtime-actions-dependencies.js`, `create-generator-page-runtime-mount-factory.js`, `create-generator-page-runtime-mount.js`, `create-generator-mounted-page-state.js`, `create-generator-mounted-page-startup-sync.js`, `create-generator-page-component-runtime-config.js`, `create-generator-page-component-config-inputs.js`, `create-generator-page-component-runtime-dependencies.js`, `create-generator-page-component-runtime-schema-dependencies.js`, `create-generator-page-component-runtime-service-dependencies.js`, `create-generator-page-component-runtime-callbacks.js`, `create-generator-page-component-runtime-controls-callbacks.js`, `create-generator-page-component-runtime-preview-callbacks.js`, `create-generator-page-component-runtime-schema-callbacks.js`, `create-generator-page-component-config-dependencies.js`, `create-generator-page-component-props.js`, `create-generator-controls-props.js`, `create-generator-preview-props.js`, `create-generator-schema-definition-props.js`, `create-generator-page-component-services.js`, `create-generator-controls-services.js`, `create-generator-preview-services.js`, `create-generator-page-component-callbacks.js`, `create-generator-controls-callbacks.js`, `create-generator-preview-callbacks.js`, `create-generator-schema-definition-callbacks.js`, `generator-mounted-page-bridge.js`, and `generator-schema-rule-helpers.js`. Runtime base-state/default assembly now lives in the dedicated runtime-base-state helper, runtime entry parser/sample-schema assembly now lives in the dedicated runtime-factory-inputs helper, the runtime schema-helper adapter layer now lives in the dedicated runtime-schema-adapters helper, the runtime-instance helper focuses on base-state assembly plus shell-config handoff, shell config now stays thin while the mount/dependency factory composition lives in the dedicated `create-generator-runtime-factories.js` helper, runtime-driven mount closure assembly now lives in the dedicated runtime-mount-factory helper, runtime-driven dependency closure assembly now lives in the dedicated runtime-dependencies-factory helper, the unavailable row-count fallback now lives in `create-generator-unavailable-row-count-result.js`, schema catalog/support assembly now lives in the dedicated runtime-schema-support-dependencies helper, schema editing-session assembly now lives in the dedicated `create-generator-runtime-schema-session-dependencies.js` helper, the remaining schema runtime/generation/state bridge assembly now lives in `create-generator-runtime-schema-bridges.js`, the remaining schema-side runtime bundle just composes those support, session, and bridge helpers inside `create-generator-runtime-schema-dependencies.js`, mounted view-state bridge assembly now lives in the dedicated `create-generator-runtime-view-state-dependencies.js` helper, runtime-action bridge assembly now lives in the dedicated `create-generator-runtime-actions-dependencies.js` helper, and the remaining runtime-dependencies bundle just composes those sub-bundles. Lifecycle-backed runtime facade assembly now lives in the dedicated `create-generator-runtime-lifecycle-facade.js` helper, the runtime-core helper now focuses on applying schema-state bridging on top of that lifecycle facade before dependency attachment, runtime facade methods live in the dedicated facade helper, schema-state property bridging lives in the dedicated runtime-schema-state helper, mount precondition checks now live in the dedicated `assert-generator-runtime-mountable.js` helper, lifecycle mount/destroy behavior live in the dedicated runtime-lifecycle helper, generator-page runtime-config assembly now lives in `create-generator-page-component-runtime-config.js`, generator-page config inputs now compose the dedicated runtime-dependency mapping helper plus the dedicated runtime-callback mapping helper, the runtime-dependency mapping helper itself now composes a schema-side dependency bundle plus a service-handle dependency bundle instead of mixing both inline, the runtime-callback mapping helper now composes dedicated controls, preview, and schema callback bundles instead of mixing those callback groups inline, and the page-config helper now composes a dedicated props-plus-services dependency bundle plus the page callback bundle instead of flattening both dependency and callback wiring in one module. Page-level props assembly, controls prop assembly, preview prop assembly, schema-definition prop assembly, service assembly, controls-service assembly, preview-service assembly, callback wiring, controls callback wiring, preview callback wiring, and schema-definition callback wiring now live in focused helpers instead of the broader page-config and mount builders, mounted-page state assembly now lives in the dedicated `create-generator-mounted-page-state.js` helper, mounted-page startup sync now lives in the dedicated `create-generator-mounted-page-startup-sync.js` helper, pure generator schema-rule helpers live outside the runtime entry module, and the runtime-mount helper now just coordinates page creation plus mounted-state plus startup-sync sequencing on top of those narrower helpers. That keeps the remaining page-runtime work focused on top-level lifecycle boundaries rather than one broad coordinator blob.
