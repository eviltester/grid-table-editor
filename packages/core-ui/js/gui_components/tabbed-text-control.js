  ...
  constructor(parentElement, theImportExportControls) {
    ...
    this.tabDefinitions = [
      ...
      },
      {
        ...
        subtasks: [
          { id: 'junit4', label: 'JUnit4', type: 'junit4' },
          { id: 'junit5', label: 'JUnit5', type: 'junit5' },
          { id: 'junit6', label: 'JUnit6', type: 'junit6' },
          { id: 'testng', label: 'TestNG', type: 'testng' },
          { id: 'pytest', label: 'PyTest', type: 'pytest' },
          { id: 'jest', label: 'Jest', type: 'jest' },
          { id: 'xunit', label: 'xUnit', type: 'xunit' },
          { id: 'rspec', label: 'RSpec', type: 'rspec' },
          { id: 'phpunit', label: 'PHPUnit', type: 'phpunit' },
          { id: 'kotest', label: 'Kotest', type: 'kotest' },
          { id: 'test-more', label: 'Test::More', type: 'test-more' },
        ],
      },
