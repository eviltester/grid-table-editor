...
- `packages/core-ui/js/gui_components/generator/runtime/data-generator-page-runtime.js`
  - The remaining live generator runtime seam is now the direct runtime plus its surviving collaborator cluster, not the older shell/facade stack. Runtime creation flows through `create-generator-runtime.js`, mounted page assembly flows through `create-generator-page-runtime-mount.js` plus `create-generator-page-runtime-config.js`, and the live action/view-state path now uses responsibility-based names such as `create-generator-runtime-collaborators.js`, `create-generator-runtime-interaction-services.js`, `create-generator-runtime-actions-service.js`, `create-generator-runtime-view-state.js`, and `create-generator-runtime-schema-runtime.js`. The main remaining cleanup is narrower follow-up regrouping only if the surviving schema-generation helper or runtime orchestration still feels broader than one clear runtime boundary.
