...
defineDomainKeywordHelpContractTests('word.noun');

describe('word.noun parameter validation', () => {
  function validateArgs(paramsText) {
    const keyword = getDomainKeywordByAlias('word.noun');
    const parsed = parseKeywordInvocation(`word.noun(${paramsText})`);
  ...
  test('executes word.noun(length=5) successfully', () => {
    const parsed = parseKeywordInvocation('word.noun(length=5)');
