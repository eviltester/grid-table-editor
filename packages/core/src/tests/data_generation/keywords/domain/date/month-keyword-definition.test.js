...
defineDomainKeywordHelpContractTests('date.month');

describe('date.month parameter validation', () => {
  function validateArgs(paramsText) {
    const keyword = getDomainKeywordByAlias('date.month');
    const parsed = parseKeywordInvocation(`date.month(${paramsText})`);
  ...
  test('executes date.month(abbreviated=true) successfully', () => {
    const parsed = parseKeywordInvocation('date.month(abbreviated=true)');
