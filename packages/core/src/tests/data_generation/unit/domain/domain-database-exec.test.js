...
describe('database domain keyword execution', () => {
  test('executes database.collation', () => {
    ...
    assertDomainKeywordResult('database.collation', result);
  });
  ...
  test('executes database.column', () => {
    ...
    assertDomainKeywordResult('database.column', result);
  });
  ...
  test('executes database.engine', () => {
    ...
    assertDomainKeywordResult('database.engine', result);
  });
