...
defineDomainKeywordHelpContractTests('word.verb');

describe('word.verb parameter validation', () => {
  function validateArgs(paramsText) {
    const keyword = getDomainKeywordByAlias('word.verb');
    const parsed = parseKeywordInvocation(`word.verb(${paramsText})`);
  ...
  test('executes word.verb(length=5) successfully', () => {
    const parsed = parseKeywordInvocation('word.verb(length=5)');
