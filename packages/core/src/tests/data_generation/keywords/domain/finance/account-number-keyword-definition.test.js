...
defineDomainKeywordHelpContractTests('finance.accountNumber');

describe('finance.accountNumber parameter validation', () => {
  function validateArgs(paramsText) {
    const keyword = getDomainKeywordByAlias('finance.accountNumber');
    const parsed = parseKeywordInvocation(`finance.accountNumber(${paramsText})`);
  ...
  test('executes finance.accountNumber(length=5) successfully', () => {
    const parsed = parseKeywordInvocation('finance.accountNumber(length=5)');
