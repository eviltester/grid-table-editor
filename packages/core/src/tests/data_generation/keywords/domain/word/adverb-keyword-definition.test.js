...
defineDomainKeywordHelpContractTests('word.adverb');

describe('word.adverb parameter validation', () => {
  function validateArgs(paramsText) {
    const keyword = getDomainKeywordByAlias('word.adverb');
    const parsed = parseKeywordInvocation(`word.adverb(${paramsText})`);
  ...
  test('executes word.adverb(length=5) successfully', () => {
    const parsed = parseKeywordInvocation('word.adverb(length=5)');
