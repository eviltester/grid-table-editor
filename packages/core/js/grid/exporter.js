...
class Exporter {
  constructor(gridExtensions) {
    ...
    this.options['unittest'] = new TestFrameworkConvertorOptions();
    this.options['nose2'] = new TestFrameworkConvertorOptions();
    this.options['jest'] = new TestFrameworkConvertorOptions();
    this.options['vitest'] = new TestFrameworkConvertorOptions();
    this.options['mocha'] = new TestFrameworkConvertorOptions();
    this.options['xunit'] = new TestFrameworkConvertorOptions();
    this.options['nunit'] = new TestFrameworkConvertorOptions();
    this.options['mstest'] = new TestFrameworkConvertorOptions();
    this.options['rspec'] = new TestFrameworkConvertorOptions();
    this.options['minitest'] = new TestFrameworkConvertorOptions();
    this.options['phpunit'] = new TestFrameworkConvertorOptions();
    this.options['pest'] = new TestFrameworkConvertorOptions();
    this.options['kotest'] = new TestFrameworkConvertorOptions();
    this.options['junit5-kotlin'] = new TestFrameworkConvertorOptions();
    this.options['spek'] = new TestFrameworkConvertorOptions();
    this.options['test-more'] = new TestFrameworkConvertorOptions();
    this.options['test2-suite'] = new TestFrameworkConvertorOptions();
    ...
    this.exporters['unittest'] = new TestFrameworkConvertor();
    this.exporters['unittest'].setFramework('unittest');
    this.exporters['nose2'] = new TestFrameworkConvertor();
    this.exporters['nose2'].setFramework('nose2');
    this.exporters['jest'] = new TestFrameworkConvertor();
    this.exporters['jest'].setFramework('jest');
    this.exporters['vitest'] = new TestFrameworkConvertor();
    this.exporters['vitest'].setFramework('vitest');
    this.exporters['mocha'] = new TestFrameworkConvertor();
    this.exporters['mocha'].setFramework('mocha');
    this.exporters['xunit'] = new TestFrameworkConvertor();
    this.exporters['xunit'].setFramework('xunit');
    this.exporters['nunit'] = new TestFrameworkConvertor();
    this.exporters['nunit'].setFramework('nunit');
    this.exporters['mstest'] = new TestFrameworkConvertor();
    this.exporters['mstest'].setFramework('mstest');
    this.exporters['rspec'] = new TestFrameworkConvertor();
    this.exporters['rspec'].setFramework('rspec');
    this.exporters['minitest'] = new TestFrameworkConvertor();
    this.exporters['minitest'].setFramework('minitest');
    this.exporters['phpunit'] = new TestFrameworkConvertor();
    this.exporters['phpunit'].setFramework('phpunit');
    this.exporters['pest'] = new TestFrameworkConvertor();
    this.exporters['pest'].setFramework('pest');
    this.exporters['kotest'] = new TestFrameworkConvertor();
    this.exporters['kotest'].setFramework('kotest');
    this.exporters['junit5-kotlin'] = new TestFrameworkConvertor();
    this.exporters['junit5-kotlin'].setFramework('junit5-kotlin');
    this.exporters['spek'] = new TestFrameworkConvertor();
    this.exporters['spek'].setFramework('spek');
    this.exporters['test-more'] = new TestFrameworkConvertor();
    this.exporters['test-more'].setFramework('test-more');
    this.exporters['test2-suite'] = new TestFrameworkConvertor();
    this.exporters['test2-suite'].setFramework('test2-suite');
