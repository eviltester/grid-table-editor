...
<td>&lt;start and end bar&gt;</td>
  ...
  test('compact output', () => {
    const expected = `<table><tr><th>heading&lt; 1</th><th>heading 2</th><th>h3</th><th>h4</th></tr><tr><td>&lt;start</td><td>data &gt; bar</td><td>end bar&gt;</td><td>&lt;start and end bar&gt;</td></tr></table>`;
...
<td>data</td>
  ...
  test('no headers no grid', () => {
    const inputtable = `<table><tr></tr></table>`;
  ...
  test('header can come from td', () => {
    const inputtable = `<table><tr><td>h1</td></tr></table>`;
  ...
  test('table can come from all tr td', () => {
    const inputtable = `<table><tr><td>h1</td></tr><tr><td>data</td></tr></table>`;
